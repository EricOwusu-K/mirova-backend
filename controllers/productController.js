...
// @desc    Provide the try-on image for a product
...
const prepareTryOn = asyncHandler(async (req, res) => {
  ...
  // Product images are already background-free, so use them directly
  res.json({ tryOnImage: product.images[0], cached: true })
})
